    ...
    if(data.length != 0){
        for(var i=0;i<data.length;i++){
            ...
            if(data[i].status == '候诊'){
                ...
                dataHtml +=  '<a class="layui-btn layui-btn-danger layui-btn-mini" onclick="visit_close(this)" valueid="'+data[i].id+'">弃诊</a><a class="layui-btn layui-btn-normal layui-btn-mini" onclick="reset_addwrite(this)" valueid="'+data[i].id+'"><i class="layui-icon" style="vertical-align: middle;margin-right: 0">&#xe60b;</i></a></td>'
            }else if(data[i].status == '治疗中'){
                dataHtml +=  '<td><a class="layui-btn layui-btn-danger layui-btn-mini" onclick="visit_close(this)" valueid="'+data[i].id+'">弃诊</a><a class="layui-btn layui-btn-normal layui-btn-mini" onclick="reset_addwrite(this)" valueid="'+data[i].id+'"><i class="layui-icon" style="vertical-align: middle;margin-right: 0">&#xe60b;</i></a></td>'
            }else{
