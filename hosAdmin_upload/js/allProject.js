        ...
        if(data.length != 0){
            for(var i=0;i<data.length;i++){
                ...
                if(data[i].isPreferential == true){
                    dataHtml += '<img style="float:right;width: 26px;" src="../../hosAdmin/img/special.png?v=cf2a4b9">';
                }
                dataHtml += '</td>'
                +'<td>'+data[i].price+'</td>';
               ...
               /* if(data[i].status == "unallot"){
                ...
                dataHtml +=  /*'<a class="layui-btn layui-btn-normal layui-btn-mini news_record_add" style="display: none" valueid="'+data[i].id+'"><i class="layui-icon">&#xe650;</i> 回访</a>' +*/
                    ...
                    '<a class="layui-btn layui-btn-normal layui-btn-mini news_reset_recordhis" onclick="reset_projectexample(this)" valueid="'+data[i].id+'" valuetype="product">添加案例</a></td>'
                    +'</tr>';
            }
        }else{
