		...
		function renderDate(data,curr){
			...
			if(currData.length != 0){
				for(var i=0;i<currData.length;i++){
			    	...
			    	+'<td>'
					+  '<a class="layui-btn layui-btn-mini news_edit" valueid="55"><i class="iconfont icon-edit"></i> 回访</a>'
					+  '<a class="layui-btn layui-btn-normal layui-btn-mini news_collect"><i class="layui-icon">&#xe600;</i> 回访记录</a>'
