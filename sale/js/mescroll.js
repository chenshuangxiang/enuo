...
;(function (name, definition) {
  ...
  MeScroll.prototype.extendDownScroll = function(optDown) {
    ...
    MeScroll.extend(optDown, {
      ...
      htmlContent: '<!--<p class="downwarp-progress"></p>--><p class="downwarp-tip">下拉刷新 </p><img class="downwarp-progress" src="option/mescroll-progress.png"/>', //布局内容
  ...
  MeScroll.prototype.extendUpScroll = function(optUp) {
    ...
    MeScroll.extend(optUp, {
      ...
      htmlLoading: '<!--<p class="upwarp-progress mescroll-rotate"></p><p class="upwarp-tip">加载中..</p>--><img class="upwarp-progress mescroll-rotate" src="option/mescroll-progress.png"/>', //上拉加载中的布局
      htmlNodata: '<!--<p class="upwarp-nodata">&#45;&#45; END &#45;&#45;</p>--><img class="upwarp-nodata" src="option/mescroll-nodata.png"/>', //无数据的布局
    ...
    if(this.optUp && this.optUp.use) {
     ...
     // debugger
        ...
        if(this.goCount == 1){
            ...
            page.goCount = 1;
            this.optUp.callback && this.optUp.callback(page, this); //执行上拉回调 下拉刷新
        }
