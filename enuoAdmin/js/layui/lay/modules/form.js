                        ...
                        if (!o) {
                            ...
                            var C = function (e, t, a) {
                                ...
                                layui.each(g, function () {
                                    var t = i(this), l = t.text(),id = t.attr("layui-value");s = myFilter(e,l,id);
...
var myFilter = function(value, text, id) {
    ...
    if (escape(value).indexOf("%u") != -1) { //汉字
        ...
        result = makePy(text)[0].toLowerCase().substring(0, len) === value || text.toLowerCase().indexOf(value) > -1 || (id === undefined ? false : id.indexOf(value) > -1);
    }
    if (result == true) {
        return false;
    } else {
