...
(function(root, factory) {
	...
	Paging.prototype = {
		...
		bindToolbar: function() {
			var _this = this;
			var html = $('<li class="ui-paging-toolbar"><select id="ui-select-pagesize" class="ui-select-pagesize"></select><input type="number" class="ui-paging-count" min="1"/><a href="javascript:void(0)">跳转</a></li>');
