...
var Go = {
    xuetang: function () { //添加血糖
        var url = SERVER_ADDR + '/app/user/bloodGlucose/addBloodGlucose';
        var Data = {};
        Data.timeBucket = $('.xueyaTime').val();
        Data.bloodGlucose = $('.xuetangVal').val();
