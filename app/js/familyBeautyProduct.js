            ...
            if(retInfo.data.cardCouponJson.hospitals.length > 0){
                ...
                retInfo.data.cardCouponJson.hospitals.forEach(function (value) {
                    ...
                    html +='<div class="doc_child_left">' +
                        ...
                        html += '<p class="name" style="font-size: 1.02rem;color: #333333;margin-top: .3rem">'+valueProduct.productName+'' ;


                        html += '<p style="color: #fb952c;margin-top: .3rem;font-size: .7rem;">合作医院:'+valueProduct.hospitalNames[0]+'</p>' ;
...
function hrefOrder(obj) {
    window.location.href = 'my_experience.html';
}
var Show = {
    func:function () {
        $('.ks_list').slideToggle();
