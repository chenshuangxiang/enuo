...
$(document).ready(function () {
    $('.xywztejia').click(function () {
        $('.xywztejia').css('color','#999').css('border','1px solid #c3c3c3').removeClass('avtivitySpan');
        $(this).css('color','#00afa1').css('border','1px solid #00afa1').addClass('avtivitySpan');
    });
});
    ...
    ajaxPay:function (ajaxUrl) {
     ...
     /*   if($('.payRightChooseZi').text() == "分单支付"){
      ...
      /*  if($('.yueRadio').is(':checked')){
        ...
        if($('.avtivitySpan').attr('value') == "four") {
            Data.type = 'four';
        }else if($('.avtivitySpan').attr('value') == "three") {
            Data.type = 'three';
        }
    ...
    ajaxPaySuccess:function (retInfo) {
        ...
        if(retInfo.success == true){
            ...
            if(is_weixn()) {
                ...
                //alert(JSON.stringify(retInfo.data))
