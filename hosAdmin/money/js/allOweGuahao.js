...
layui.use(['form','layer','jquery','laypage','laydate'],function(){
    ...
    searchBtn(localStorage.getItem('allOweGuahao') || 1);
    localStorage.removeItem('allOweGuahao');
...
function searchBtn(pageNumber) {
    ...
    var url = SERVER_ADDR + "/hospital/finance/getRegistrationFee/debtList.json";
    var data = {};
   ...
   /* layui.layer.open({
    ...
    if(payMethods == "undefined"){
        ...
        var index = layui.layer.open({
            ...
            type : 2,
            area: ['800px','80%'],
            content : 'orderDetailOweGuahao.html?id=' + id + '&v=1134',
            success : function(layero, index){
