...
layui.use(['form','layer','jquery','laypage','laydate'],function(){
    ...
    searchBtn(localStorage.getItem('allFinanceGuahao') || 1);
    localStorage.removeItem('allFinanceGuahao');
...
function searchBtn(pageNumber) {
    ...
    var url = SERVER_ADDR + "/hospital/finance/getRegistrationFee/printingBillList.json";
    var data = {};
