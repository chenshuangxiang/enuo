        ...
        if(data && data.length != 0){
            for(var i=0;i<data.length;i++){
                ...
                if(!data[i].name){
                    ...
                    dataHtml+='<td valueid="'+data[i].id+'" valuename="'+data[i].name+'" valueIndex="0"  valuetype="'+data[i].type+'" onclick="specialProductOpen(this)" style="color: #2299ee;cursor: pointer;">'+noData(data[i].name)+'</td>'
                }
