layui.use(['form','layer','jquery','laypage','upload'],function(){
   ...
   /* form.on('select(newsHos)', function(data){  //根据医院获取病种
	...
	function searchBtn(pageNumber) {
        ...
        var url = SERVER_ADDR + "/hospital/medicalRecordTemplate/getMedicalRecordTemplateList.json";
        var data = {};
    ...
    $(".addTemplateOne").click(function(){
        ...
        var index = layui.layer.open({
            ...
            type : 2,
            area:['60%','80%'],
            content : "addStaticPatientTemplate.html",
...
function resetTemplate(obj) {
    ...
    var index = layui.layer.open({
        ...
        type : 2,
        area:['60%','80%'],
        content : "addStaticPatientTemplate.html?valueid=" + id + '&action=reset',
        success : function(layero, index){
