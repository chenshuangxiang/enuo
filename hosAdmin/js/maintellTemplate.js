layui.use(['form','layer','jquery','laypage','upload'],function(){
   ...
   /* form.on('select(newsHos)', function(data){  //根据医院获取病种
	...
	function searchBtn(pageNumber) {
        ...
        var url = SERVER_ADDR + "/hospital/complainTemplate/all";
        var data = {};
    ...
    $(".addTemplateOne").click(function(){
        ...
        var index = layui.layer.open({
            ...
            type : 2,
            area:['450px','350px'],
            content : "addmaintellTemplate.html",
...
function resetTemplate(obj) {
    ...
    var index = layui.layer.open({
        ...
        type : 2,
        area:['85%','85%'],
        content : "maintellsubTemplate.html?valueid=" + id,
        success : function(layero, index){
...
function delTemplate(obj) {
    ...
    layer.confirm('确认删除？', {
        ...
        var url = SERVER_ADDR + "/hospital/complainTemplate/delete/one";
        var data = {};
