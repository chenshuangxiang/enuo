...
layui.use(['form','layer','jquery','laypage','laydate','element','table'],function(){
    ...
    table.render({
        elem: '#zixunNow'
        ,cols: [[ //标题栏
            {field: 'name', title: '项目名称',  width: 120,edit: 'text'}
            //,{field: 'category', title: '费用类别', width: 90,edit: 'text'}
            ,{field: 'modelNo', title: '品名', width: 100,edit: 'text'}
            ...
            ,{field: 'price', title: '约定价格', width: 90,edit: 'text'}
            //,{field: 'experience', title: '优惠券额', width: 100,edit: 'text'}
            ,{field: 'paidAmount', title: '已付金额', width: 90,edit: 'text'}
            ,{field: 'quantity', title: '数量', width: 80,edit: 'text'}
            ,{field: 'day', title: '约定天数', width: 90,edit: 'text'}
            ,{field: 'result', title: '约定疗效', width: 150,edit: 'text'}
            ,{field: 'receiveName', title: '指定医生', width: 140,templet: '#selectDoctor'}
            ,{field: 'delZixunNow', title: '操作', width: 90,toolbar: '#delZixunNow'}
