layui.use(['form','layer','jquery','laypage','laydate'],function(){
    ...
    $('.todayRecordZixun').addClass('layui-this').parent().parent().addClass('layui-nav-itemed');
	//加载页面数据
    laydate.render({
        elem: '#newsTime'
    });
	...
	function searchBtn(pageNumber) {
        ...
        var url = SERVER_ADDR + "/hospital/allot/getTodayAccess.json";
        var data = {};
