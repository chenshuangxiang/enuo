        ...
        if(data.length != 0){
            for(var i=0;i<data.length;i++){
                ...
                dataHtml += '<tr>'
                 ...
                 /*  +'<td><input type="checkbox" name="checked" lay-skin="primary" lay-filter="choose"></td>'*/
                  /*  +'<td>'+new Date(data[i].createDate).Format("yyyy-MM-dd hh:mm:ss")+'</td>'*/
                    +'<td  style="color: #2299ee;cursor: pointer" onclick="getUserDetail(this)" valueid="'+data[i].id+'"  valuemobile="'+data[i].mobile+'">'+data[i].fullname+'</td>'
                    +'<td>'+data[i].sex+'</td>'
                    +'<td>'+data[i].mobile+'</td>'
                    +'<td>'+birthday+'</td>'
                if(window.location.href.indexOf('recent') != -1){
               ...
               // dataHtml +=  /*'<a class="layui-btn layui-btn-normal layui-btn-mini news_record_add" style="display: none" valueid="'+data[i].id+'"><i class="layui-icon">&#xe650;</i> 回访</a>' +*/
                ...
                dataHtml += '<td><a class="layui-btn layui-btn-normal layui-btn-mini news_reset_recordhis" style="padding: 0 9px;" onclick="news_reset_recordhis(this)" valueid="'+data[i].id+'"  valuemobile="'+data[i].mobile+'">回访</a></td>';
                dataHtml +='</tr>';
            }
        }else{
