...
layui.use(['form','layer','jquery','laypage','laydate','element'],function(){
    ...
    $('.alreadySkill').addClass('layui-this').parent().parent().addClass('layui-nav-itemed');
...
function renderDate(data){
    ...
    if(data.length != 0){
        for(var i=0;i<data.length;i++){
            ...
            dataHtml +=  '<td><a class="layui-btn layui-btn-normal layui-btn-mini" onclick="getPhotos(this)" valueid="'+data[i].mobile+'">查看</a></td>'
           /* if(data[i].status == '候诊'){
