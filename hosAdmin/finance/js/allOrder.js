        ...
        if(data.length != 0){
            for(var i=0;i<data.length;i++){
                ...
                if (data[i].hospitalUserId) {
                    dataHtml +='<td  style="color: #2299ee;cursor: pointer" onclick="visitUserJiuzhenInfo(this)" valueindex="1" valueid="'+data[i].hospitalUserId+'"  valuemobile="'+data[i].mobile+'">'+data[i].fullname+'</td>'
                }else{
               ...
               /* if(data[i].type == 'project'){
                ...
                if (data[i].orderType == 'offline') {
                    dataHtml += '<td  style="color: #2299ee;cursor: pointer" onclick="readOrderOpen(this)" valueid="'+data[i].userOfflineProjectId+'" fkid="'+data[i].fkId+'">' + data[i].name + '</td>';
                } else {
                ...
                if(data[i].orderStatus == 'waitPaid'){
                    dataHtml += '<td class="hoverUnderline" valueid="'+data[i].id+'" style="color: red">待支付</td>';
                }else if(data[i].orderStatus == 'waitConfirm'){
                    if(data[i].isReservation == true){
                        dataHtml += '<td class="hoverUnderline" valueid="'+data[i].id+'" style="color: #1e9fff">已支付<span style="color: #009688">(已预约)</span></td>';
                    }else if(data[i].isReservation == false){
                        dataHtml += '<td class="hoverUnderline" valueid="'+data[i].id+'" style="color: #1e9fff">已支付<span style="color: red">(未预约)</span></td>';
                    }else{
                        dataHtml += '<td class="hoverUnderline" valueid="'+data[i].id+'">已支付</td>';
                    }
                }else if(data[i].orderStatus == 'completed'){
                    dataHtml += '<td class="hoverUnderline" valueid="'+data[i].id+'" style="color: #ff6600">待结算</td>';
                }else if(data[i].orderStatus == 'cancelled'){
                    dataHtml += '<td class="hoverUnderline" valueid="'+data[i].id+'" style="color: #666666">已取消</td>';
                }else if(data[i].orderStatus == 'handle'){
                    dataHtml += '<td class="hoverUnderline" valueid="'+data[i].id+'" style="color: #009688">已完成</td>';
                }
