          ...
          /*  if(data[i].type == "coupon"){
            ...
            dataHtml += '<td>挂号费</td>' +
               ...
               /* +'<td>'+data[i].paidAmount +'/'+ data[i].totalPrice+'</td>'*/
                +'<td>'+data[i].payMethod +'</td>';
            if(data[i].id){
                dataHtml += '<td style="color: #2299ee;cursor: pointer" valueid="'+data[i].id+'" onclick="readOrderGuahaoOpen(this)">'+data[i].amount+'</td>'
            }else if(data[i].registrationFeeForVisitRecordId){
                dataHtml += '<td style="color: #2299ee;cursor: pointer" valueid="'+data[i].registrationFeeForVisitRecordId+'" onclick="readOrderGuahaoOpen(this)">'+data[i].paidAmount+'</td>'
            }else {
                dataHtml += '<td>暂未开单</td>';
            }
