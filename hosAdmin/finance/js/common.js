...
var SERVER_ADDR = 'http://127.0.0.1';//'http://www.enuo120.com';;////'http://127.0.0.1:7070';// /////;//'///;'//;////;//
var chatTime;
//订单--根据类型统计
function chooseType() {
    var totlePrice = 0;
...
function noPriceData(name) { //undefind数据 返回name
    if(!name || name == '' || name == 'undefined'){
        name = '0';
    }
    return name
}
function readOrderOpen(obj) {
...
function readOrderGuahaoOpen(obj) {
    var id = $(obj).attr('valueid');
    var index = layui.layer.open({
        title : "缴费详情",
        type : 2,
...
//个人/就诊信息
function visitUserJiuzhenInfo(obj){
